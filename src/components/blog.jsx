  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-bold mt-2 text-green-600">Latest Posts & Articles</h2>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-5">
            ...
            <h3 className="text-lg font-bold mb-2 text-green-600">Medical Of This Working Health Blog</h3>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-5">
            ...
            <h3 className="text-lg font-bold mb-2 text-green-600">There Is Only One Thing That Is Hospital.</h3>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-5">
            ...
            <h3 className="text-lg font-bold mb-2 text-green-600">This Working World and Infection Prevention.</h3>
